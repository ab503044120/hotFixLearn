...
public class AndroidHack {
    ...
    public static HackPlus.HackedMethod0<android.content.res.AssetManager, Void, HackPlus.Unchecked, HackPlus.Unchecked, HackPlus.Unchecked> AssetManager_construct;
    ...
    public static HackPlus.HackedMethod0<Void, android.content.res.AssetManager, HackPlus.Unchecked, HackPlus.Unchecked, HackPlus.Unchecked> AssetManager_ensureStringBlocks;


    //>=19
    public static HackPlus.HackedClass<Object> ResourcesManager;
    public static HackPlus.HackedMethod0<Object, Void, HackPlus.Unchecked, HackPlus.Unchecked, HackPlus.Unchecked> ResourcesManager_getInstance;
    public static HackPlus.HackedField<Object, ArrayMap> ResourcesManager_mActiveResources;
    //>=24
    public static HackPlus.HackedField<Object, ArrayList> ResourcesManager_mResourceReferences;

    //<19
    public static HackPlus.HackedClass<Object> ActivityThread;
    public static HackPlus.HackedMethod0<Void, Void, HackPlus.Unchecked, HackPlus.Unchecked, HackPlus.Unchecked> ActivityThread_currentActivityThread;
    public static HackPlus.HackedField<Object, HashMap> ActivityThread_mActiveResources;


    //>=24
    public static HackPlus.HackedField<Resources, Object> Resources_ResourcesImpl;
    public static HackPlus.HackedField<Object, Object> ResourcesImpl_mAssets;
    //<24
    public static HackPlus.HackedField<Resources, Object> Resources_mAssets;
    ...
    private static void initAssertion() {
        HackPlus.setAssertionFailureHandler(new HackPlus.AssertionFailureHandler() {
            @Override
            public void onAssertionFailure(final HackPlus.AssertionException failure) {
                if (!sIsIgnoreFailure) {
                    if (exceptionArray == null) {
