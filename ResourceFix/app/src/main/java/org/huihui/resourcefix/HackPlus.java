...
public class HackPlus {
    ...
    public static class HackedField<C, T> {
        ...
        private HackedTargetField<T> onTarget(final @Nullable C target) {
            return new HackedTargetField<>(mField, target);
        }
    ...
    private static class HackedMethodImpl<R, C, T1 extends Throwable, T2 extends Throwable, T3 extends Throwable> implements NonNullHackedMethod<R, C, T1, T2, T3> {
        ...
        @Override
        public <TT extends Throwable> HackedMethod<R, C, TT, T2, T3> throwing(final Class<TT> type) {
        ...
        @Override
        public <TT1 extends Throwable, TT2 extends Throwable> HackedMethod<R, C, TT1, TT2, T3>
        ...
        @Override
        public <TT1 extends Throwable, TT2 extends Throwable, TT3 extends Throwable> HackedMethod<R, C, TT1, TT2, TT3>
        ...
        public <A1> HackedMethod1<R, C, T1, T2, T3, A1> withParam(final Class<A1> type) {
            ...
            return method == null ? null : new HackedMethod1<R, C, T1, T2, T3, A1>() {
                @Override
                public HackInvocation<R, C, T1, T2, T3> invokeWithParam(final A1 arg) {
        ...
        public <A1, A2> HackedMethod2<R, C, T1, T2, T3, A1, A2> withParams(final Class<A1> type1, final Class<A2> type2) {
            ...
            return method == null ? null : new HackedMethod2<R, C, T1, T2, T3, A1, A2>() {
                @Override
                public HackInvocation<R, C, T1, T2, T3> invokeWithParams(final A1 arg1, final A2 arg2) {
        ...
        public <A1, A2, A3> HackedMethod3<R, C, T1, T2, T3, A1, A2, A3> withParams(final Class<A1> type1, final Class<A2> type2, final Class<A3> type3) {
            ...
            return method == null ? null : new HackedMethod3<R, C, T1, T2, T3, A1, A2, A3>() {
                @Override
                public HackInvocation<R, C, T1, T2, T3> invokeWithParams(final A1 arg1, final A2 arg2, final A3 arg3) {
        ...
        public <A1, A2, A3, A4> HackedMethod4<R, C, T1, T2, T3, A1, A2, A3, A4> withParams(final Class<A1> type1, final Class<A2> type2, final Class<A3> type3, final Class<A4> type4) {
            ...
            return method == null ? null : new HackedMethod4<R, C, T1, T2, T3, A1, A2, A3, A4>() {
                @Override
                public HackInvocation<R, C, T1, T2, T3> invokeWithParams(final A1 arg1, final A2 arg2, final A3 arg3, final A4 arg4) {
        ...
        public <A1, A2, A3, A4, A5> HackedMethod5<R, C, T1, T2, T3, A1, A2, A3, A4, A5> withParams(final Class<A1> type1, final Class<A2> type2, final Class<A3> type3, final Class<A4> type4, final Class<A5> type5) {
            ...
            return method == null ? null : new HackedMethod5<R, C, T1, T2, T3, A1, A2, A3, A4, A5>() {
                @Override
                public HackInvocation<R, C, T1, T2, T3> invokeWithParams(final A1 arg1, final A2 arg2, final A3 arg3, final A4 arg4, final A5 arg5) {
        ...
        public HackedMethodN<R, C, T1, T2, T3> withParams(final Class<?>... types) {
            ...
            return method == null ? null : new HackedMethodN<R, C, T1, T2, T3>() {
                @Override
                public HackInvocation<R, C, T1, T2, T3> invokeWithParams(final Object... args) {
        ...
        private
        @Nullable
        Invokable findInvokable(final Class<?>... param_types) {
            final int modifiers;
    ...
    private static class FallbackInvokable<C> implements Invokable<C> {
        ...
        FallbackInvokable(final Object value) {
            mValue = value;
        }
    ...
    public static class HackedClass<C> {
        ...
        public <T> HackedField<C, T> field(final String name) {
            ...
            };    // Anonymous derived class ensures
        }
        ...
        public
        @CheckResult
        HackedInvokable<C, Void, Unchecked, Unchecked, Unchecked> constructor() {
